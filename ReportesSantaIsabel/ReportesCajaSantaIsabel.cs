...
{
    public partial class ReportesCajaSantaIsabel : KryptonForm
    {
        #region Singleton
        private static ReportesCajaSantaIsabel frm = null;
        public static ReportesCajaSantaIsabel Instance()
        {

            if (frm == null)
            {
                frm = new ReportesCajaSantaIsabel();
            }
            return frm;
        }
        #endregion
        ...
        public ReportesCajaSantaIsabel()
        {
            InitializeComponent();
        ...
        #endregion
        #region Load
        private void ReportesCajaSantaIsabel_Load(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(Properties.Settings.Default.SI);
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(con))
                {
                    using (SqlCommand cmd = new SqlCommand("sp_informe_total_vehiculos", connection))
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        connection.Close();
                        this.sp_informe_total_vehiculosTableAdapter.Fill(this.CajaSantaIsabelDataSet.sp_informe_total_vehiculos, Convert.ToDateTime(fecha));
                    }
                }
